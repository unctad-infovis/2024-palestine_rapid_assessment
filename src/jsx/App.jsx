      ...
      <div>
        ...
        <div className="chart_container scroller">
          <Scroller
            ...
            source="Damage analysis of Copernicus Sentinel-1 satellite data by Corey Scher of CUNY Graduate Center and Jamon Van Den Hoek of Oregon State University. Available at: https://www.conflict-damage.org. The maps display 40m × 40m cells where a value of 0 represents no detectable damage, while a value of 1 represents likely damage in human settlements (cities, towns, villages)."
            subtitle={['Original damage maps. 7 October – 22 November 2023.', 'Original damage maps. 23 November – 30 November 2023.', 'Original damage maps. 7 October – 28 December 2023']}
            title="The unprecedented level of destruction in the Gaza Strip rendering it uninhabitable"
          />
        </div>
        <div className="content_container">
          <p>To estimate the immediate impact of the damage caused by the Israeli military operation on economic activity and household welfare, proxied by NTL, a panel of 365 grid cells of 1km² was constructed for the whole of the Gaza strip. Each cell is observed from October 5th to December 28th, 2023.</p>
        ...
        <div className="chart_container scroller">
          <Scroller
            ...
            legend="damage"
            note="The period between November 23rd and 29th includes the ceasefire. The associated measurement represents the number of bombed 40m × 40m cells within each grid cell. Up to December 28th, the average number of bombed cells is 136 per km² (21.7% of each grid surface). The 1km² grid cell with the highest number of bombed 40m × 40m cells is in Beit Lahiya, with 624 cells bombed out of 625 (99.8% of its grid surface)."
            ...
            subtitle={['Damage intensity grids of 1km². 7 October – 22 November 2023', 'Damage intensity grids of 1km². 23 November – 30 November 2023', 'Damage intensity grids of 1km². 7 October – 28 December 2023']}
            title="Some areas in Gaza are completely destroyed by the Israeli military operation"
          />
        </div>
        <div className="img_container">
        ...
        <div className="chart_container scroller">
          <Scroller
            ...
            legend="ntl"
            note="The measurement used is at-sensor day/night boundary radiance during the night of each respective day, expressed in watt per steradian per square centimetre, aggregated at a 500m × 500m level. Each grid cell is a 1km² area which represents the average of the four 500m × 500m sensor measurements of at-sensor day/night boundary radiance during the night of each respective day."
            source="UNCTAD calculations based on the Black Marble NASA project, and specifically the VNP46A1 VIIRS/NPP Daily Gridded Day Night Band Linear Lat Lon Grid Night product suite. The data is publicly available at https://ladsweb.modaps.eosdis.nasa.gov"
            ...
            title="The Gaza strip gets darker as economic activity ground to a halt in all sectors"
          />
        </div>
        <div className="content_container">
