  ...
  return (
    <div className="app">
      ...
      <div className="cover_container" style={{ paddingBottom: 0 }}>
        ...
        <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : './assets/img/2024-palestine_rapid_assessment_world-min.png'}`} alt="" />
      ...
      <p className="button_container"><a href="#download" className="button_blue">Download the report in PDF</a></p>
      {
      // Section 1 container
      }
      <div>
        ...
        <div className="chart_container">
          ...
          <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : 'https://dummyimage.com/1000x1:1/f1f1f1/000&text=Ocha Map'}`} alt="" />
          <h6>
            <em>Source:</em>
            {' '}
            <span>OCHA oPT</span>
        ...
        <div className="img_container">
          <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : './assets/img/2024-palestine_rapid_assessment_photo1-min.jpg'}`} alt="" />
        </div>
        <div className="content_container">
          <p>According to UNOSAT, until November 26th only, the Israeli bombardment damaged 37,379 buildings or 18 per cent of the total structures in Gaza.5 In 2014, 51 days of bombardment, damaged 22,737 structures.</p>
      ...
      <div>
        ...
        <div className="img_container">
          <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : './assets/img/2024-palestine_rapid_assessment_photo2-min.jpg'}`} alt="" />
        </div>
        <div className="content_container">
        ...
        <div className="chart_container">
          <Scroller title="The unprecedented level of destruction in the Gaza Strip rendering it uninhabitable" source="Damage analysis of Copernicus Sentinel-1 satellite data by Corey Scher of CUNY Graduate Center and Jamon Van Den Hoek of Oregon State University. Available at:( https://www.conflict-damage.org/ ). The maps display 40m x 40m cells where a value of 0 represents no detectable damage, while a value of 1 represents likely damage in human settlements (cities, towns, villages)." note="Each red pixel represents a 40m × 40m area that has been bombed within the time period of the map." image="2024-palestine_rapid_assessment_damage" subtitle="Original damage maps." images={['2024-palestine_rapid_assessment_damage_40x40_0', '2024-palestine_rapid_assessment_damage_40x40_1', '2024-palestine_rapid_assessment_damage_40x40_2']} captions={[{ text: 'The first wave of bombing concentrated in the northern parts of Gaza including Gaza city', date: '7 October – 22 November', date_title: 'The first 6 weeks' }, { text: 'During the ceasefire the amount damage was limited', date: '24 November – 29 November', date_title: 'The cease fire' }, { text: 'The second wave of bombing extended from northern parts of Gaza to Khan Younis in the south', date: '5 October – 28 December', date_title: 'Overall' }]} />
        </div>
        <div className="content_container">
          <p>To estimate the immediate impact of the damage caused by the Israeli military operation on economic activity and household welfare, proxied by NTL, a panel of 365 grid cells of 1 km2 was constructed for the whole of the Gaza strip. Each cell is observed from October 5th to December 28th, 2023.</p>
        ...
        <div className="chart_container">
          <Scroller title="Some areas in Gaza are completely destroyed by the Israeli military operation" source="UNCTAD calculations based on the Damage Analysis of Copernicus Sentinel-1 satellite data by Corey Scher of CUNY Graduate Center and Jamon Van Den Hoek of Oregon State University." note="The period between November 23rd and 29th includes the ceasefire. The associated measurement represents the number of bombed 40m x 40m cells within each grid cell. Up to December 28th, the average number of bombed cells is 136 per km2 (21.7% of each grid surface). The 1 km2 grid cell with the highest number of bombed 40m x 40m cells is in Beit Lahiya, with 624 cells bombed out of 625 (99.8% of its grid surface)." image="2024-palestine_rapid_assessment_damage" subtitle="Damage intensity grids of 1 km2." images={['2024-palestine_rapid_assessment_damage_1x1_0', '2024-palestine_rapid_assessment_damage_1x1_1', '2024-palestine_rapid_assessment_damage_1x1_2']} captions={[{ text: 'The first wave of bombing concentrated in the northern parts of Gaza including Gaza city', date: '7 October – 22 November', date_title: 'The first 6 weeks' }, { text: 'During the ceasefire the amount damage was limited', date: '24 November – 29 November', date_title: 'The cease fire' }, { text: 'The second wave of bombing extended from northern parts of Gaza to Khan Younis in the south', date: '5 October – 28 December', date_title: 'Overall' }]} legend="damage" />
        </div>
        <div className="img_container">
          <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : './assets/img/2024-palestine_rapid_assessment_photo3-min.jpg'}`} alt="" />
        </div>
        <div className="chart_container">
          <Scroller title="The Gaza strip gets darker as economic activity ground to a halt in all sectors" source="UNCTAD calculations based on the Black Marble NASA project, and specifically the VNP46A1 VIIRS/NPP Daily Gridded Day Night Band Linear Lat Lon Grid Night product suite. The data is publicly available at https://ladsweb. modaps.eosdis.nasa. gov/." note="The measurement used is at-sensor day/night boundary radiance during the night of each respective day, expressed in watt per steradian per square centimetre, aggregated at a 500 x 500 m level. Each grid cell is a 1 km2 area which represents the average of the four 500m × 500m sensor measurements of at-sensor day/night boundary radiance during the night of each respective day." image="2024-palestine_rapid_assessment_damage" subtitle="Night time luminosity (NTL) at different days during the Israeli military operation." images={['2024-palestine_rapid_assessment_ntl_1x1_0', '2024-palestine_rapid_assessment_ntl_1x1_1', '2024-palestine_rapid_assessment_ntl_1x1_2', '2024-palestine_rapid_assessment_ntl_1x1_3']} captions={[{ text: 'Before the operation Gaza city, Khan Younis and Rafah were the most luminous', date: '22 September – 6 October', date_title: 'Average before the war' }, { text: 'Especially Gaza City looses in the north looses luminosity during the first weeks', date: '22 November – 23 November', date_title: 'Night before the cease fire' }, { text: 'By the end of the ceasefire Khan Youinis and Rafah became most luminous as people displaced moved further to the south', date: '29 November – 30 November', date_title: 'Last night of the cease fire' }, { text: 'By the end of the second wave of Israeli bombing concentrated in Khan Younis, Rafah was the most luminous in the Gaza strip ', date: 'Night of 27 December – 28 December' }]} legend="ntl" />
        </div>
        <div className="content_container">
          ...
          <p>
            ...
            {' '}
            of bombing on NTL: a 1 percent increase in bombing intensity (i.e. a 1 percent increase in the number of 40m x 40m cells bombed in each square kilometer grid cell), on average, is associated with a 6.2 per cent loss in NTL. The grid cells that suffered the highest level of bombing experienced a loss of NTL in excess of 50 per cent.
          </p>
        ...
        <div className="content_container">
          ...
          <p>Between 15 October and 26 November, the number of damaged buildings increased by approximately 355 per cent. Figure 7a shows the map of damage intensity per km2 for the three periods.</p>
        </div>
        <div className="chart_container">
          <h4>Damage intensity per km2 in Gaza localities between three assessments</h4>
        ...
        <div className="img_container">
          <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : './assets/img/2024-palestine_rapid_assessment_photo4-min.jpg'}`} alt="" />
        </div>
      </div>
      {
      // Section 3 container
      ...
      <div>
        ...
        <div className="img_container">
          <img src={`${window.location.href.includes('unctad.org') ? 'https://storage.unctad.org/2023-a_trade_hope/assets/img/' : './assets/img/2024-palestine_rapid_assessment_photo5-min.jpg'}`} alt="" />
        </div>
        <div className="content_container">
