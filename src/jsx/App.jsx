  ...
  return (
    <div className="app">
      ...
      <div>
        ...
        <div className="chart_container">
          <Scroller title="The unprecedented level of destruction in the Gaza Strip rendering it uninhabitable" source="Source" note="Note" image="2024-palestine_rapid_assessment_damage" images={['2024-palestine_rapid_assessment_damage_40x40_0', '2024-palestine_rapid_assessment_damage_40x40_1', '2024-palestine_rapid_assessment_damage_40x40_2']} captions={['The map shows all the areas in Gaza that were bombed before the cease fire', 'During the cease fire the amount damage was limited', 'The map shows you how by 29 December most of Gaza city is bombed extensively']} />
        </div>
        <div className="content_container">
        ...
        <div className="chart_container">
          <Scroller title="Some areas in Gaza are completely destroyed by the Israeli military operation" source="Source" note="Note" image="2024-palestine_rapid_assessment_damage" images={['2024-palestine_rapid_assessment_damage_1x1_0', '2024-palestine_rapid_assessment_damage_1x1_1', '2024-palestine_rapid_assessment_damage_1x1_2']} captions={['The map shows all the areas in Gaza that were bombed before the cease fire', 'During the cease fire the amount damage was limited', 'The map shows you how by 29 December most of Gaza city is bombed extensively']} />
        </div>
        <div className="img_container">
        ...
        <div className="chart_container">
          <Scroller title="The Gaza strip gets darker as economic activity ground to a halt in all sectors" source="Source" note="Note" image="2024-palestine_rapid_assessment_damage" images={['2024-palestine_rapid_assessment_ntl_1x1_0', '2024-palestine_rapid_assessment_ntl_1x1_1', '2024-palestine_rapid_assessment_ntl_1x1_2', '2024-palestine_rapid_assessment_ntl_1x1_3']} captions={['Before the war started Gaza City in the north and Rafa crossing in the south were the most luminated areas Gaza Strip', 'Already before the cease fire most luminated ares shown in yellow start to move towards the south', 'During the cease fire this trend continued, Gaza city in the north becomes less luminated', 'The latest data shows that the Rafa crossing has become the only area with most luminosity.']} />
        </div>
        <div className="content_container">
